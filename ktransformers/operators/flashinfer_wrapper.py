...
if __name__ == "__main__":
    ...
    q_nope = torch.randn((1, num_heads, 512), dtype=torch.bfloat16, device="musa")
    q_pe = torch.randn((1, num_heads, 64), dtype=torch.bfloat16, device="musa")
    ckv = torch.randn((max_pages, page_size, 512), dtype=torch.bfloat16, device="musa")
    k_pe = torch.randn((max_pages, page_size, 64), dtype=torch.bfloat16, device="musa")
    ...
    kv_len_arr = torch.tensor([10], dtype=torch.int32, device="musa")
